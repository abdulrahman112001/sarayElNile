...
export default function Footer() {
  return (
    <footer className="font-sans tracking-wide bg-white px-8 py-12">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-6 gap-y-10">
            ...
            <li>
              <a href="javascript:void(0)">
                <svg
                  ...
                  fill="none"
                  className="fill-black hover:fill-gray-700 w-7 h-7"
                  viewBox="0 0 24 24"
                >
                  <path
                    fillRule="evenodd"
        ...
        <div>
          <ul className="mt-6 space-y-5 ml-10">
            <li>
              <a
                href="javascript:void(0)"
                className="hover:text-gray-900 text-yellow-700 font-segoe text-sm font-semibold"
              >
                Web Development
              </a>
            </li>
            <li>
              <a
                href="javascript:void(0)"
                className="hover:text-gray-900 text-black text-sm"
              >
                Pricing
              </a>
            </li>
      ...
      <div className="flex flex-wrap max-md:flex-col gap-4 bg-yellow-700 sm:mt-12">
        <p className=" md:flex md:space-x-6 max-md:space-y-2 p-1 text-white ml-4 font-segoe font-light">
          All rights reserved.
        </p>
      </div>
    </footer>
